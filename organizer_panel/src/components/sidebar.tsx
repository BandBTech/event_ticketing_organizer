...
import { LayoutDashboard, Calendar, ChartLine, Settings, ChevronRight } from "lucide-react";
    ...
    <aside className="w-56 min-h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <nav className="flex-1 space-y-1 px-4 " >
            ...
            <Link key={href} href={href} className="no-underline hover:no-underline">
              <div
                className={`flex items-center gap-3 px-4 py-2 cursor-pointer transition-all
                  ${isActive
                    ? "border-l-2 border-blue-600 bg-blue-50 dark:bg-blue-950"
        ...
        <div className="flex  items-center gap-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 p-2 ">
          <img src="/avatar.jpg" alt="John Doe" className="w-8 h-8 rounded-full" />
