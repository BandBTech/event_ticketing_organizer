  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Selling Events</h3>
        {isLoading ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="text-right py-2 px-3 text-gray-500 font-medium">Tickets Sold</th>
